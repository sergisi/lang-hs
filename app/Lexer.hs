...
alex_action_0 =  skip 
alex_action_1 =  token (\(_, _, _, s) _ -> LRealReg $ head s)
alex_action_2 =  token (\(_, _, _, s) _ -> LIntReg $ head s)
alex_action_3 =  tk LAssign 
alex_action_4 =  tk LMult 
alex_action_5 =  tk LDiv 
alex_action_6 =  tk LSum 
alex_action_7 =  tk LMinus 
alex_action_8 =  tk LLBrack 
alex_action_9 =  tk LRBrack 
alex_action_10 =  token (\(_, _, _, s) len -> LInt . read $ take len s) 
alex_action_11 =  token (\(_, _, _, s) len -> LDouble . read $ take len s) 
alex_action_12 =  tk LSync 
alex_action_13 =  tk LDivInt 
alex_action_14 =  tk LMod 
alex_action_15 =  tk LRightShift 
alex_action_16 =  tk LLeftShift 
alex_action_17 =  tk LCompAUn 
alex_action_18 =  tk LAnd 
alex_action_19 =  tk LOr 
alex_action_20 =  tk LXor 
alex_action_21 =  tk LIntToReal 
alex_action_22 =  tk LRealToInt 
